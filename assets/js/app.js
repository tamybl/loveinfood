      ...
      function addUserBD (uid,name) {
        ...
        $('#menu-user').html('<li><a href="#"><button type="button" class="btn btn-default text-uppercase" id="show-profile">ver Perfil</button></a></li><li><a href="#"><button type="button" class="btn btn-default text-uppercase" id="close_session">Cerrar Sesión</button></a></li>');
          ...
          $('#show-profile').click(function () {
            ...
            $(".welcome").html('<div class="col-xs-12 col-md-3"><img src="'+photoURL+'" alt="" class="img-thumbnail"></div><div class="col-xs-12 col-md-9"><h3 class="nametitle">'+displayName+' <span class="hidden-xs pull-right"><i class="fa fa-star fa-lg" aria-hidden="true"></i><i class="fa fa-star fa-lg" aria-hidden="true"></i><i class="fa fa-star fa-lg" aria-hidden="true"></i><i class="fa fa-star fa-lg" aria-hidden="true"></i><i class="fa fa-star-o fa-lg" aria-hidden="true"></i></span></h3><div class="row text-center"><div class="col-xs-4 col-md-4"><h4 class="visible-xs-*"><i class="fa fa-picture-o" aria-hidden="true"></i></h4><h4 class="hidden-xs">Publicaciones</h4><h3>22</h3></div><div class="col-xs-4 col-md-4"><h4 class="visible-xs-*"><i class="fa fa-cutlery" aria-hidden="true"></i></h4><h4 class="hidden-xs">Recetas</h4><h3>5</h3></div><div class="col-xs-4 col-md-4"><h4 class="visible-xs-*"><i class="fa fa-list-ul" aria-hidden="true"></i></h4><h4 class="hidden-xs">Listas</h4><h3>2</h3></div></div></div>');
